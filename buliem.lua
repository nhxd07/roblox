...
local GameGETHUBFUNCTION = "nhxd07/UI/main/NhexeXUI.lua"
...
Number = math.random(1, 1000000)
    ...
    K:Toggle("Auto Teleports To Kitsune Island",false,function(value)
    ...
    K:Toggle("Auto Teleport To Kitsune Shrine",false,function(value)
    ...
    K:Toggle("Auto Collect Azure Ember",false,function(value)
