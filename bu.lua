...
Check_Map = function()
	...
	end																																																																																																								NameFN = "Check_Map_________________________________"
	return { 
...
wait(.2)
do
    if game:WaitForChild("CoreGui"):FindFirstChild("Zee Hub V0.0.1") then
		game:WaitForChild("CoreGui"):FindFirstChild("Zee Hub V0.0.1"):Destroy()
	end
end
...
ZeeHubV001.Name = "Zee Hub V0.0.1"
...
function library:XoxHi()
    ...
    TextHub.Position = UDim2.new(0.0181818176, 0, 0.1369863, 0)
    TextHub.Size = UDim2.new(0, 90, 0, 16)
    TextHub.Font = Enum.Font.FredokaOne
    TextHub.Text = "Hub | UI V 2.0.1"
    ...
    local Top_Tab = Instance.new("Frame")
    ...
    Top_Tab.Name = "Top_Tab"
    Top_Tab.Parent = Main
    Top_Tab.BackgroundColor3 = Color3.new(1, 1, 1)
    Top_Tab.BackgroundTransparency = 1
    Top_Tab.BorderColor3 = Color3.new(0, 0, 0)
    Top_Tab.BorderSizePixel = 0
    Top_Tab.Position = UDim2.new(0.0923681557, 0, 0.218966261, 0)
    Top_Tab.Size = UDim2.new(0, 530, 0, 250)
        ...
        TextButton.MouseButton1Click:Connect(function()
            for _, x in next, TabContainer:GetChildren() do
                if x.Name == "Tap" then
                    ...
                    for index, y in next, Top_Tab:GetChildren() do
                        if y.Name == "Page" then
