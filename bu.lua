...
if World2 then
Auto1:Toggle("Auto Farm Radioactive Material",false,function(value)
Radioactive = value
...
if World3 then  
Auto1:Toggle("Auto Farm Conjured Cocoa",false,function(value)
Cocoafarm = value
StopTween(Cocoafarm)
end)
...
if World3 then     
Auto1:Toggle("Auto Farm Fish Tail World 3",false,function(value)
Fish = value
StopTween(Fish)
end)
...
Auto1:Toggle("Auto Tushita", _G.Autotushita,function(value)
    ...
    Auto1:Toggle("Auto Cavander", _G.AutoCarvenderhop,function(value)
...
Auto1:Toggle("Auto Haki Button",_G.Farm_Ob_Color,function(vu)
	Open_Color_Haki = vu
...
Auto1:Toggle("Auto SeaBest",_G.Auto_Seabest,function(value)
...
Auto1:Toggle('Auto SeaBest Hop', false, function(value)
...
Race1:Button("Teleport To Acient One",function()
  topos(CFrame.new(28981.552734375, 14888.4267578125, -120.245849609375))
   ...
   Race1:Button("Unlock Lever.", function()
...
Race1:Toggle("Auto Buy Gear",_G.Auto_Farm_Bone4,function(value)
...
Race1:Toggle("Auto Ancient One Quest",_G.AutoRace,function(value)
 _G.AutoRace = value
 StardFarm = value
...
spawn(function()
  ...
  Race1:Toggle("Auto Kill Player in Trail",false,function(Val)
  _G.AutoKillTial = Val
...
if not game.Players.LocalPlayer.Character:FindFirstChild("HasBuso") then
  ...
  Race1:Toggle("Auto Trail RaceV4",false,function(v)
  _G.AutoQuestRace = v
